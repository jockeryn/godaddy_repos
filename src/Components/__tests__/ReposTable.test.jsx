...
test('Sholud render a table with repos', () => {
    render(<ReposTable repos={repos}/>, {wrapper: MemoryRouter})
    const tableRepos = screen.getByTestId('repos-table')
    expect(tableRepos).toBeInTheDocument();
    expect(tableRepos).toContainHTML('<h3 class="h5">godaddy/gdapi-php</h3>')
})